  ...
  return (
    <div style={{ border: "1px solid #e5e7eb", borderRadius: 8, overflow: "hidden" }}>
      <div style={{
        ...
        padding: "8px 16px", fontSize: 12, fontWeight: 600, color: "#6b7280",
      ...
      <div style={{
        height: 240, overflowY: "auto", background: "#0f172a",
      ...
      <div style={{
        ...
        padding: "6px 16px", display: "flex", gap: 14, flexWrap: "wrap",
      }}>
        {Object.entries(KIND_LABEL).map(([kind, label]) => (
          <span key={kind} style={{ fontSize: 10, color: KIND_COLORS[kind], fontFamily: "monospace" }}>
            {label.trim()}
          </span>
        ))}
      </div>
